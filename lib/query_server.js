...
module.exports = function() {
  ...
  return {
    ...
    exited: function(callback) {
      return couchjs.exited(callback);
    },
    ...
    list_row: function(row) {
      return function(cb) {
        var cmd = JSON.stringify(['list_row', row]);
        couchjs.write(cmd, cb);
      }
    },
    ...
    list_end: function() {
      return function(cb) {
        couchjs.write(JSON.stringify(['list_end']), cb);
      }
    },
